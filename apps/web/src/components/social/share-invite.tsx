...
const MaxIcon = (
  <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
    <path d="M12 2L2 7l10 5 10-5-10-5zm0 7.18L4.43 5.5 12 1.82l7.57 3.68L12 9.18zM2 17l10 5 10-5-2.18-1.09L12 19.82 4.18 15.91 2 17zm0-5l10 5 10-5-2.18-1.09L12 14.82 4.18 10.91 2 12z"/>
  </svg>
)
